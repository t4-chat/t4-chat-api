...
Revision ID: a0adf57bc7dd
Revises: 
Create Date: 2025-06-03 21:56:57.814518-05:00
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_agg_ai_chat_messages_id'), 'chat_messages', ['id'], unique=False, schema='agg_ai')
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_agg_ai_chat_messages_id'), table_name='chat_messages', schema='agg_ai')
