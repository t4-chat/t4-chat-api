...
Revision ID: 1e5e3e240c23
Revises: 
Create Date: 2025-06-14 13:20:12.977611-05:00
...
def upgrade() -> None:
    ...
    sa.Column('model_id', sa.UUID(), nullable=True),
                    sa.Column('image_gen_model_id', sa.UUID(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['chat_id'], ['agg_ai.chats.id'], ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(['image_gen_model_id'], ['agg_ai.ai_provider_models.id'],
                                            ondelete='SET NULL'),
