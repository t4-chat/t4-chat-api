...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_agg_ai_ai_providers_id"),
        "ai_providers",
        ["id"],
        unique=False,
        schema="agg_ai",
    ...
    op.create_index(
        op.f("ix_agg_ai_budget_id"), "budget", ["id"], unique=False, schema="agg_ai"
    )
    op.create_table(
        "user_group",
        sa.Column("name", sa.String(), nullable=False),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["provider_id"], ["agg_ai.ai_providers.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
        schema="agg_ai",
    )
    op.create_index(
        op.f("ix_agg_ai_ai_provider_models_id"),
        "ai_provider_models",
        ["id"],
        unique=False,
        schema="agg_ai",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["model_id"], ["agg_ai.ai_provider_models.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
        schema="agg_ai",
    )
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "user_group_name", "limits_id", name="uq_user_group_limits"
        ),
        schema="agg_ai",
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_agg_ai_resources_id"), table_name="resources", schema="agg_ai"
    )
    ...
    op.drop_index(
        op.f("ix_agg_ai_ai_providers_id"), table_name="ai_providers", schema="agg_ai"
    )
